              ...
              <React.Fragment key={"kFragment " + i}>
                <Box key={`li-${k}`} className="p-1">
                  <div key={`div-${k}`} className="section p-2">
                    ...
                    <span
                      key={`sp-jlpt-${k}`}
                      className={`jlpt-${jlpt || "unknown"} jlpt px-2`}
                      style={{ display: "block" }}
                    >
                      {jlpt ? `N${jlpt}` : "unknown"}
                    </span>
                    <section className="row container">
                      {meanings_string.split(/,(?![^()]*\))/).map((m, j) => {
                        return (
                          <span key={`sp-m-${j}`} className="col-auto mm mt-2">
                            {m.trim()}
                          </span>
                        );
                      })}
                ...
                {userSubmitted && (
                  <>
                    <div>
                      ...
                      <Text fontSize={"4xl"} className="ent" fontWeight={"100"}>
                    ...
                    <div>
                      ...
                      <Text fontSize={"2xl"} className="ent" fontWeight={"100"}>
